...
class Hibrido_ColorPalette_Block_Adminhtml_Rules_Form extends FormContainer
{
    protected function _prepareLayout()
    {
        $this->setChild(
            'form',
            $this->getLayout()->createBlock('colorpalette/Adminhtml_rules_form_edit')
        );
    ...
    {
        return Mage::helper('colorpalette')->__('Cores Dinâmicas');
    }
